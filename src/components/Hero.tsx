...
export default function Hero() {
  return (
    <section className="relative h-[500px] lg:h-[650px] overflow-hidden bg-primary">
      ...
      <div className="container-custom relative z-10 h-full flex flex-col justify-center">
        <div className="max-w-2xl text-white">
          ...
          >
            <span className="inline-block bg-accent text-white text-xs font-bold uppercase tracking-widest px-3 py-1 rounded-sm mb-6">
              Spring Sale Now On
            </span>
            ...
            <p className="text-lg lg:text-xl text-slate-200 mb-10 max-w-lg leading-relaxed">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link to="/knowledge" className="bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white font-semibold py-3 px-8 rounded-md transition-all duration-200 border border-white/30">
                Knowledge Centre
              </Link>
            </div>
          </motion.div>
