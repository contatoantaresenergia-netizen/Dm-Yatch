...
export default function Hero() {
  return (
    <section className="relative min-h-[80vh] lg:h-[650px] overflow-hidden bg-primary">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t sm:bg-gradient-to-r from-primary/90 via-primary/70 to-transparent"></div>
      </div>

      {/* Content */}
      <div className="container-custom relative z-10 h-full flex flex-col justify-center px-4 sm:px-6 lg:px-0">
        <div className="max-w-md sm:max-w-lg lg:max-w-2xl text-white">
          <motion.div
          ...
          >
            ...
            <p className="text-base sm:text-lg lg:text-xl text-slate-200 mb-6 sm:mb-10 max-w-lg leading-relaxed">
